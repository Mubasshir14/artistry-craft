...
import { Link, useNavigate } from "react-router-dom"; // make sure to import useNavigate if you use it
...
const SignIn = () => {
    const { signIn, user, auth } = useContext(AuthContext);
    const navigate = useNavigate(); // to use navigate for redirection
    const from = "/"; // or any path you want to navigate to after login
        ...
        <div className="mt-6">
            <div className="w-full max-w-md mx-auto p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                ...
                <form onSubmit={handleSignIn } className="space-y-8">
                    ...
                    <input type="submit" value="SignIn" className="w-full p-3 text-white font-bold rounded-lg bg-[#23BE0A]" />
