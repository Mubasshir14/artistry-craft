...
const SignUp = () => {
    const { createUser, auth, updateUserProfile, user, setUser } = useContext(AuthContext);
    ...
    const handleSignUp = e => {
        ...
        console.log(name, email, password, photo, phone);
        ...
        createUser(email, password, photo)
            .then((res) => {
                ...
                fetch('https://artistry-craft-server-1.onrender.com/user', {
                    method: 'POST',
                    headers: {
                    ...
                    <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                        ...
                        <div className="w-full">
                            ...
                            <form onSubmit={handleSignUp} className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                                ...
                                <div className="md:col-span-2 col-span-1">
                                    <button
                                        className="text-center w-full bg-[#23BE0A] p-3 text-white rounded-lg">
                                        <span>Sign Up </span>
